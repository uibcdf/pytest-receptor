...
1. **`roadmap_to_1.0_publication.md`** — exact resume point and checklist from
   the paused release candidate through GitHub, PyPI, `uibcdf` conda, and the
   automated pytest community plugin report. Start here.
2. **`release_1.0_readiness.md`** — architecture gates and their evidence.
3. **`audit_action_register_2026-07-17.md`** — the complete work queue. Every
   task in the project has an identifier here.
4. **`scope_0.6.md`** — the accepted design of the current renderer and its
   reliability floor.
5. **`critical_audit_2026-07-17.md`** — why the plan looks the way it does.
...
| --- | --- | --- |
| `roadmap_to_1.0_publication.md` | Release roadmap | **Active resume point.** Ordered gates, commands, stop conditions, and evidence required to publish the same 1.0.0 commit on GitHub, PyPI, and `uibcdf` conda, then verify pytest's automated community listing. |
