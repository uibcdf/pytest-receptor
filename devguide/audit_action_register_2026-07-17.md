...
| PR-REL-008 | Medium | Package and CI metadata stop at Python 3.13 | Demonstrate Python 3.14 across the pytest 8/9 matrix, then align metadata, packaging, documentation, public release, and clean-install evidence under `uibcdf/molsyssuite#29` | post | 4 | **active: 1.1.0 promotion** |
